...
void jarvis_judice_ninke_dither(uint8_t *image, unsigned width, unsigned height, unsigned channels, uint8_t threshold) {
...
static PyObject *dither_jarvis_judice_ninke(PyObject *self, PyObject *args) {
    ...
    jarvis_judice_ninke_dither(image_data, width, height, 4, threshold);
