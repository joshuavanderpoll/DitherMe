...
static PyMethodDef CheckeredMethods[] = {
    {"dither", dither_checkered, METH_VARARGS, "Apply a large checkerboard dithering to a PNG image."},
    {NULL, NULL, 0, NULL}
};
...
static struct PyModuleDef checkeredmodule = {
    ...
    "checkered_large",
    "Large checkerboard dithering module.",
    -1,
    CheckeredMethods
};

PyMODINIT_FUNC PyInit_checkered_large(void) {
